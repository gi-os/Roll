...
**Current version:** `versionName` in `app/build.gradle.kts` is `2.52.0`. CI adds the run number
as the patch, so the release from the current `main` is `v2.52.x`. See
